...
public:
    PokemonGym();
    ~PokemonGym();
    PokemonGym(unsigned int max_training_units, unsigned int stamina_cost, double dollar_cost, unsigned int exp_points_per_training, int in_id, Point2D point2d);
    bool Update();
    void ShowStatus();
